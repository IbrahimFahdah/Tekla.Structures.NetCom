...
namespace Exercise
{
    public partial class Form1 : Form
    {
        ...
        /// <returns></returns>
        private void CreatePadFooting(double PositionX, double PositionY)
        {
            IBeam PadFooting1 = MyModel.CreateBeam();
            ...
            PadFooting1.Position.Rotation = RotationEnum.FRONT;
            PadFooting1.Position.Plane = PlaneEnum.MIDDLE;
            PadFooting1.Position.Depth = DepthEnum.MIDDLE;
